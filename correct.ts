...
var ad : any[] = [
    {book : new Books("HTML", "Ducket", "HTML", 200)},
    {book : new Books("CSS", "Ducket", "CSS", 300)},
    {book : new Books("JavaScript", "John Doe", "JavaScript", 500)},
    {car : new Cars("Vitz", "Honda", 2016, 1200, "black", 500000)},
    {car : new Cars("Corolla", "Toyota", 2016, 1500, "white", 540000)},
    {car : new Cars("CheryQQ", "Santro", 2016, 1000, "red", 205000)},
    {mobile :new Mobiles("S1", "Qmobile", "black", 5, 11000)},
    {mobile :new Mobiles("J1-Ace", "Samsung", "blue", 4.5, 19000)},
    {mobile :new Mobiles("X90", "Motorolla", "white", 5, 27000)}
]; 
...
for (var i = 6; i <= 8; i++) {
    showMobile = ad[i].mobile.display();
